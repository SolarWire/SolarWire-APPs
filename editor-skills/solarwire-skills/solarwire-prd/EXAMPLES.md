...
- [SolarWire PRD - Note Writing Examples](#solarwire-prd---note-writing-examples)
  ...
  - [Chart Elements](#chart-elements)
    ...
    - [Chart Color Palette (Tailwind CSS)](#chart-color-palette-tailwind-css)
  - [Timeline \& Log Elements](#timeline--log-elements)
    ...
    - [Timeline Status Colors (Tailwind CSS)](#timeline-status-colors-tailwind-css)
    - [Activity Log Action Types (Tailwind CSS)](#activity-log-action-types-tailwind-css)
