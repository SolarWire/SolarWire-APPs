...
export const useFileStore = create<FileState>()((set, get) => ({
  ...
  openFileAtPath: async (filePath: string) => {
    ...
    try {
      ...
      const normalizedCurrentPath = normalizeForCompare(currentPath);
      const isRootLevel = normalizedCurrentPath === '.' || normalizedCurrentPath === '';
      const needsSwitch = !currentPath || (!isRootLevel && !normalizeForCompare(filePath).startsWith(normalizedCurrentPath + '/'));
