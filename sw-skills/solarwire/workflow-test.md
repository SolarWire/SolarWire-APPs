...
3. Failure handling
   - If login fails, show error toast 'Invalid credentials', clear password field, and shake button
4. Disabled conditions
   - While any input is empty, disable button
   - While format validation fails, disable button"""
```
...
2. Field descriptions
   ...
   - Name: User display name; If not set, show 'Not set'
   - Status: While 1, show 'Active'; While 0, show 'Disabled' in red
   - Created: Always format as YYYY-MM-DD HH:mm
```
