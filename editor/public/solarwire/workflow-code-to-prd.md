...
1. Field descriptions
   - Step: Always shows approval stage name
   - Status: Always shows current status
   - Time: Always shows action timestamp"""
  # bg=#F9FAFB bold
    ["Step"]
    ["Status"]
    ["Time"]
...
1. Display condition
   - While data is loading, show loading placeholder
2. Behavior
   - When data loads successfully, hide loading and show actual data list"""
```
