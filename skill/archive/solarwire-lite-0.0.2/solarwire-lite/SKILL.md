---
name: "solarwire-lite"
description: "SolarWire-lite is an AI-powered toolkit for software development, covering PRD creation, code reverse engineering, test case generation, dev design, implementation planning, and wireframe syntax validation. All wireframes use SolarWire code blocks."
---
...
9.  Code reverse engineering output must be a 1:1 representation of the existing code. No additions, removals, renames, or "improvements" beyond what the user explicitly requests.
