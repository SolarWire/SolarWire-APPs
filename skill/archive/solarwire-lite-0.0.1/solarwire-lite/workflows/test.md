...
```bash
node sw-skills/solarwire/scripts/lib/generate-excel.js from-md \
...
```bash
node sw-skills/solarwire/scripts/lib/generate-excel.js create --output .solarwire/[req-name]/test-cases.xlsx
node sw-skills/solarwire/scripts/lib/generate-excel.js append-batch --file .solarwire/[req-name]/test-cases.xlsx --json-file batch.json
node sw-skills/solarwire/scripts/lib/generate-excel.js finalize --file .solarwire/[req-name]/test-cases.xlsx
```
